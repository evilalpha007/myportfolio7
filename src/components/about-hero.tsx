...
import heroProfileImg from "@/public/images/ligth-yagami.jpg";
      ...
      <div className="sm:1/2 mt-10 w-full lg:w-1/2">
        <AnimatePresence>
          ...
          <FadeUp key="description-2" duration={0.6} delay={0.4}>
            <p className="mt-8 text-base font-medium text-zinc-900 dark:text-zinc-300 sm:text-lg md:text-lg">
              Explore my latest projects showcasing my expertise in Reactjs, html, css ,tailwind css
              , Javascript, Typescript, Node.js, animations  and web
              development.
            </p>
          </FadeUp>
          <FadeRight
